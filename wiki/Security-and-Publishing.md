...
Create `/LICENSE` (Personal Use, Non-Commercial):

```
GitHub Security Audit - Personal Use License

Copyright (c) 2026 [Your Name/Organization]

Permission is granted to use, copy, and modify this software and associated
documentation files for personal, educational, and internal non-commercial
purposes only.
